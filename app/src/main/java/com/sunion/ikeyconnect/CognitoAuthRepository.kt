    ...
    private fun mappingException(exception: Throwable): Throwable =
        when (exception) {
            is AmazonServiceException -> {
                when (exception) {
                    is UsernameExistsException -> com.sunion.ikeyconnect.domain.exception.UsernameExistsException()
                    is UserNotFoundException -> com.sunion.ikeyconnect.domain.exception.UserNotFoundException()
